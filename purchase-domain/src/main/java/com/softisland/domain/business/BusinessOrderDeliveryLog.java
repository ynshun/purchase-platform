 ...
 */
@Table(name = "business_order_delivery_log")
public class BusinessOrderDeliveryLog implements Serializable {
	private static final long serialVersionUID = -4342956607789927092L;
