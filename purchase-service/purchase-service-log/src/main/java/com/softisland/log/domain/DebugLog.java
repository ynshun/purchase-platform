...
public class DebugLog extends CatalinaLog {
	private static final long serialVersionUID = -4770426320120816292L;

	@SuppressWarnings("unchecked")
	public static DebugLog buildInstance(MapData logInfo) {
